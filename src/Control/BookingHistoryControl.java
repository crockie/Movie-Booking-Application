...
public class BookingHistoryControl implements Controller {
	...
	/**
	 * This function goes through all the cineplexes, cinemas, movie times and bookings to find the Customer's bookings
	 * The information of the bookings is returned as a string 
	 * @return a {@code List} of {@code String} objects containing the information about each of the Customer's bookings
	 */
	public List<String> getBookingHistory() {
		List<String> customerBookingHistory = new ArrayList<String>();
		
		for (Cineplex cineplex: DataController.getDataBase().getCineplexList()) {
